...
import { Container, Text, Title, Button } from '@/components'
  ...
  return (
    <section className={cn('px-5 py-10', className)} {...props}>
      <Container className='relative max-w-screen-1216'>
        <StarIcon className='absolute left-[35%] top-0 hidden 768:block 960:left-[35%] 960:top-[10%] 1216:left-[38%] 1216:top-[30px]' />
        ...
        <div className='flex flex-col justify-between gap-5 768:flex-row'>
          ...
          <div className='flex flex-col justify-end gap-[30px] 768:w-2/3 1216:gap-[46px]'>
            <div className='flex flex-col gap-5'>
              ...
              <Button asChild className='768:mx-auto 768:w-[186px]'>
                <Link href={NavigationRouting.CATEGORY}>Shop now</Link>
              </Button>
            </div>
